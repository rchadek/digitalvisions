<?php
/**
 * Title: Section with text, button, animated background
 * Slug: powder/hero-basic-text-button-animated
...
<div class="wp-block-group alignfull" style="margin-top:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-group">
		...
		<p class="has-text-align-center"><?php echo esc_html__( 'Powder offers an extensive library of patterns and versatile templates.', 'powder' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
